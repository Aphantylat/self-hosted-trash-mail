    ...
    <div class="container">
        ...
        <div class="row" id="address-box-normal">
            ...
            <div class="col my-address-block">
                <span id="my-address"><?php echo $user->address ?></span>&nbsp;<button class="copy-button" data-clipboard-target="#my-address">
                    Copy
                </button>
            </div>
...
<main>
    <div class="container">
		...
		<div align="center"><i>Waiting for incomming email</i></div>
                    <div class="spinner">
                        <div class="rect1"></div>
                        <div class="rect2"></div>
                        <div class="rect3"></div>
...
<footer>
    <div class="container">
         <small class="text-justify quick-summary">
            ...
            Emails will be deleted after 3 days or less.
